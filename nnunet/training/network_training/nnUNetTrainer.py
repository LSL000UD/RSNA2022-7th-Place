...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.oversample_foreground_percent = float(os.environ.get('nnUNet_fg_sample_radio'))
        # ---------------------------- Modify from original nnunet --------------------------- #
    ...
    def run_online_evaluation(self, output, target):
        with torch.no_grad():
            ...
            try:
                ...
                self.online_eval_foreground_dc.append([-1])
                self.online_eval_tp.append([-1])
                self.online_eval_fp.append([-1])
                self.online_eval_fn.append([-1])
