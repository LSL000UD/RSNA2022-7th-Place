...
class NetworkTrainer(object):
    ...
    def run_training(self):
        ...
        while self.epoch < self.max_num_epochs:
            ...
            # ---------------------------- Modify from original nnunet --------------------------- #
            use_time_this_epoch = epoch_end_time - epoch_start_time
            may_need_time_to_finish = (self.max_num_epochs - self.epoch) * use_time_this_epoch / 3600.
            self.print_to_log_file("This epoch took %f s, may still need %f hours \n" % (use_time_this_epoch, may_need_time_to_finish))
            # ---------------------------- Modify from original nnunet --------------------------- #
